...
def generate_launch_description():
    ...
    gui_config = os.path.join(desc_pkg, "config", "fivebar_gui.config")  # isometric initial camera
    ...
    moveit_config = (
        MoveItConfigsBuilder("fivebar_linkage", package_name="closed_loop_moveit_config")
        ...
        .joint_limits(file_path="config/fivebar_linkage_joint_limits.yaml")
        .trajectory_execution(file_path="config/fivebar_linkage_moveit_controllers.yaml")
