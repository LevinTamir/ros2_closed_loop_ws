"""Plan motions for the closed-loop delta_4dof in MoveIt/RViz and execute them in Gazebo.
...
Renders of the single 4dof_delta xacro:
...
ROBOT = "delta_4dof"
XACRO = "4dof_delta.urdf.xacro"
CONTROLLERS = "delta_4dof_controllers.yaml"
...
def generate_launch_description():
    ...
    gui_config = os.path.join(desc_pkg, "config", "delta_4dof_gui.config")  # isometric initial camera
